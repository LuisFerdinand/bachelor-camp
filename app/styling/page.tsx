  ...
  const colorPalettes = [
    {
      ...
      colors: [
        { name: "brand-50", value: "#eff6ff", class: "bg-brand-50" },
        { name: "brand-100", value: "#dbeafe", class: "bg-brand-100" },
        { name: "brand-200", value: "#bfdbfe", class: "bg-brand-200" },
        { name: "brand-300", value: "#93c5fd", class: "bg-brand-300" },
        { name: "brand-400", value: "#60a5fa", class: "bg-brand-400" },
        { name: "brand-500", value: "#3b82f6", class: "bg-brand-500" },
        { name: "brand-600", value: "#083bbc", class: "bg-brand-600" },
        { name: "brand-700", value: "#1d4ed8", class: "bg-brand-700" },
        { name: "brand-800", value: "#1e40af", class: "bg-brand-800" },
        { name: "brand-900", value: "#1e3a8a", class: "bg-brand-900" },
      ],
    },
    {
      name: "Accent (Yellow)",
      ...
      colors: [
        { name: "accent-50", value: "#fefce8", class: "bg-accent-50" },
        { name: "accent-100", value: "#fef9c3", class: "bg-accent-100" },
        { name: "accent-200", value: "#fef08a", class: "bg-accent-200" },
        { name: "accent-300", value: "#fde047", class: "bg-accent-300" },
        { name: "accent-400", value: "#facc15", class: "bg-accent-400" },
        { name: "accent-500", value: "#EFE914", class: "bg-accent-500" },
        { name: "accent-600", value: "#ca8a04", class: "bg-accent-600" },
        { name: "accent-700", value: "#a16207", class: "bg-accent-700" },
        { name: "accent-800", value: "#854d0e", class: "bg-accent-800" },
        { name: "accent-900", value: "#713f12", class: "bg-accent-900" },
      ],
    },
    {
      name: "Electric (Blue)",
      description:
        "Tertiary electric blue colors for highlights and special elements",
      colors: [
        { name: "electric-50", value: "#f0f9ff", class: "bg-electric-50" },
        { name: "electric-100", value: "#e0f2fe", class: "bg-electric-100" },
        { name: "electric-200", value: "#bae6fd", class: "bg-electric-200" },
        { name: "electric-300", value: "#7dd3fc", class: "bg-electric-300" },
        { name: "electric-400", value: "#38bdf8", class: "bg-electric-400" },
        { name: "electric-500", value: "#1F85F5", class: "bg-electric-500" },
        { name: "electric-600", value: "#0284c7", class: "bg-electric-600" },
        { name: "electric-700", value: "#0369a1", class: "bg-electric-700" },
        { name: "electric-800", value: "#075985", class: "bg-electric-800" },
        { name: "electric-900", value: "#0c4a6e", class: "bg-electric-900" },
      ],
    },
  ];
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-neutral-600 max-w-2xl mx-auto">
            A comprehensive guide to our professional color palette, typography,
            and component system using vibrant yet professional colors.
          </p>
        </div>
          ...
          <TabsContent value="examples" className="space-y-8">
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              <Card className="overflow-hidden">
                ...
                <CardContent className="p-6">
                  ...
                  <p className="text-neutral-600 mb-4">
                    This card demonstrates the use of our vibrant brand colors
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button
                      size="sm"
                      variant="outline"
                      className="border-accent-500 text-accent-600 hover:bg-accent-500 hover:text-white"
                    >
                      Contact Us
                    </Button>
                  </div>
              ...
              <Card className="overflow-hidden">
                ...
                <CardContent className="p-6">
                  ...
                  <p className="text-neutral-600 mb-4">
                    Orange accent colors create warmth and energy while
                    remaining business-appropriate.
                  </p>
                  <div className="flex gap-2">
                    <Button
                      size="sm"
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Best practices for implementing our design system
                </CardDescription>
              </CardHeader>
              <CardContent>
        ...
        <div className="text-center text-sm text-neutral-600">
          <p>
            Design System v1.0 - Built with Next.js, Tailwind CSS, and Shadcn/UI
          </p>
          <p className="mt-1">
            Professional vibrant colors for modern applications
          </p>
        </div>
      </div>
    </div>
