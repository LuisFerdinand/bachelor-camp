      ...
      <section className="py-12 bg-background-primary flex-grow">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Contact Form */}
            <div>
              <div className="bg-background-secondary rounded-xl shadow-medium p-6 md:p-8">
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                      <label htmlFor="phone" className="block text-text-secondary mb-2">Phone</label>
                      <input
                        type="tel"
                        id="phone"
                        name="phone"
                  ...
                  <button type="submit" className="w-full bg-primary-600 hover:bg-primary-700 text-white font-medium py-3 px-6 rounded-lg transition-colors">
                    Send Message
                  </button>
                </form>
              </div>
            ...
            {/* Contact Information */}
            <div>
              <div className="bg-background-secondary rounded-xl shadow-medium p-6 md:p-8 mb-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-text-primary mb-1">Our Location</h3>
                      <p className="text-text-secondary">123 Education Street<br />Jakarta, Indonesia 12345</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-text-secondary">(021) 123-4567</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-text-secondary">Monday - Friday: 9:00 AM - 6:00 PM<br />Saturday: 9:00 AM - 2:00 PM<br />Sunday: Closed</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* Social Media */}
              <div className="bg-background-secondary rounded-xl shadow-medium p-6 md:p-8">
                <h2 className="text-2xl font-bold text-text-primary mb-6">Connect With Us</h2>
                <p className="text-text-secondary mb-6">Follow us on social media for updates, tips, and learning resources.</p>
                
                <div className="flex space-x-4">
                  <a href="#" className="w-12 h-12 rounded-full bg-background-primary flex items-center justify-center text-text-muted hover:bg-primary-100 hover:text-primary-600 transition-colors">
          ...
          {/* Map Section */}
          <div className="mt-12 bg-background-secondary rounded-xl shadow-medium overflow-hidden">
            <h2 className="text-2xl font-bold text-text-primary p-6 pb-0">Find Us</h2>
            <div className="h-96 bg-gradient-subtle flex items-center justify-center">
              <p className="text-text-secondary">Map will be displayed here</p>
            </div>
          </div>
        </div>
      </section>
