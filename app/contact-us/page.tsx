          ...
          <div className="relative z-10 container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg md:text-xl text-white/90 mb-8 max-w-3xl mx-auto drop-shadow-md leading-relaxed">
                Your premier English learning destination in Kediri. 
                Contact us today to start your language journey.
              </p>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-lg text-neutral-600">
                ...
                Our experienced teachers, modern facilities, and comprehensive curriculum ensure you achieve your language learning goals.
              </p>
            </div>
                  ...
                  <div className="p-8 bg-gradient-to-br from-brand-50 to-accent-50">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <a href={`tel:${BachelorCamp.phone}`} className="text-neutral-600 hover:text-brand-500 transition-colors">
                            {BachelorCamp.phone}
                          </a>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <a href={`mailto:${BachelorCamp.email}`} className="text-neutral-600 hover:text-brand-500 transition-colors">
                            {BachelorCamp.email}
                          </a>
                        </div>
                      </div>
                    ...
                    <div className="mt-8 flex flex-col sm:flex-row gap-3">
                      <Button 
                        ...
                        onClick={() => window.open(`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(BachelorCamp.address)}`, '_blank')}
                      >
                      ...
                      <Button 
                        variant="outline"
                        className="flex-1"
                        onClick={() => window.open(`https://www.google.com/maps/dir/?api=1&destination=${encodeURIComponent(BachelorCamp.address)}`, '_blank')}
                      >
                        Navigate to Campus
                      </Button>
                    </div>
