...
export default function ProgramPage({ cmsData }: ProgramPageProps) {
  ...
  const heroImages = {
    mobile: {
      src: cmsData?.heroMobileImage?.url || "https://images.unsplash.com/photo-1524995997946-a1c2e315a42f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=600&q=80",
      alt: cmsData?.heroMobileImage?.alt || "English language classroom - mobile view"
    },
    desktop: {
      src: cmsData?.heroDesktopImage?.url || "https://images.unsplash.com/photo-1503676260728-1c00da094a0b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1920&q=80",
      alt: cmsData?.heroDesktopImage?.alt || "English language classroom - desktop view"
    }
  }
  ...
  const schedules = [
    {
      ...
      options: [
        { type: "Weekday Classes", schedule: "Mon-Fri, 9:00-11:00 AM", duration: "2/4/12 weeks" },
        { type: "Evening Classes", schedule: "Mon-Fri, 6:00-8:00 PM", duration: "2/4/12 weeks" },
        { type: "Weekend Classes", schedule: "Sat-Sun, 9:00 AM-1:00 PM", duration: "4/12 weeks" }
      ]
    },
    {
      program: "IELTS Mastery",
      options: [
        { type: "Intensive Weekday", schedule: "Mon-Fri, 2:00-5:00 PM", duration: "10 weeks" },
        { type: "Weekend Intensive", schedule: "Sat-Sun, 9:00 AM-4:00 PM", duration: "10 weeks" }
      ]
    },
    {
      program: "TOEFL Preparation",
      options: [
        { type: "Weekday Classes", schedule: "Mon-Wed-Fri, 2:00-5:00 PM", duration: "8 weeks" },
        { type: "Weekend Classes", schedule: "Sat-Sun, 9:00 AM-1:00 PM", duration: "8 weeks" }
      ]
    },
    {
      program: "TOEIC Intensive",
      options: [
        { type: "Weekday Classes", schedule: "Tue-Thu, 6:00-8:00 PM", duration: "6 weeks" },
        { type: "Weekend Classes", schedule: "Sat, 9:00 AM-4:00 PM", duration: "6 weeks" }
      ]
    },
    {
      program: "PET Preparation",
      options: [
        { type: "Weekday Classes", schedule: "Mon-Wed-Fri, 4:00-6:00 PM", duration: "8 weeks" },
        { type: "Weekend Classes", schedule: "Sun, 9:00 AM-4:00 PM", duration: "8 weeks" }
      ]
    }
  ]

  const requirements = [
    { program: "General English", items: ["Minimum age: 17 years", "Basic education background", "Placement test required"] },
    { program: "IELTS Mastery", items: ["Minimum age: 17 years", "Intermediate English level (B1)", "Valid ID required"] },
    { program: "TOEFL Preparation", items: ["Minimum age: 17 years", "Intermediate English level (B1)", "Valid ID required"] },
    { program: "TOEIC Intensive", items: ["Minimum age: 17 years", "Basic business experience recommended", "Valid ID required"] },
    { program: "PET Preparation", items: ["Minimum age: 16 years", "Elementary English level (A2)", "Valid ID required"] }
  ]

  const outcomes = [
    { program: "General English", items: ["Improved communication skills", "Confidence in everyday situations", "Cultural understanding"] },
    { program: "IELTS Mastery", items: ["Target band score: 6.5-7.5+", "Exam strategies mastery", "Academic language proficiency"] },
    { program: "TOEFL Preparation", items: ["Target score: 80-100+", "Academic English skills", "Test-taking techniques"] },
    { program: "TOEIC Intensive", items: ["Target score: 750-900+", "Business communication skills", "Workplace vocabulary mastery"] },
    { program: "PET Preparation", items: ["Cambridge PET certification", "Practical English skills", "Confidence in daily communication"] }
  ]
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Basic validation
    if (!formData.name || !formData.email || !formData.phone || !formData.currentLevel || !formData.programInterest) {
      setFormError(true)
      return
    }
    ...
    <div className="min-h-screen flex flex-col bg-white">      
      <main className="flex-grow">
                      ...
                      <div className="mb-6">
                        ...
                        <div className="space-y-3">
                          {program.durationOptions.map((option, index) => (
                            <div key={index} className={`p-3 rounded-lg border ${option.popular ? 'bg-accent-50 border-accent-200' : 'bg-neutral-50 border-neutral-200'}`}>
                              <div className="flex justify-between items-center">
                                <span>{option.weeks} {option.weeks === 1 ? 'week' : 'weeks'}</span>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-2xl mx-auto mb-16">
              <h2 className="text-display-sm md:text-display-md font-bold mb-4">Schedule & Pricing</h2>
              <p className="text-lg text-neutral-600">
            ...
            <Tabs defaultValue="general" className="w-full max-w-5xl mx-auto">
              ...
              {schedules.map((schedule) => (
                <TabsContent key={schedule.program} value={schedule.program.toLowerCase().split(' ')[0]}>
                  <Card>
                    <CardHeader>
                      <CardTitle className="text-xl">{schedule.program} Schedule Options</CardTitle>
                      <CardDescription>Choose the schedule that works best for you</CardDescription>
                    </CardHeader>
                    <CardContent>
                        ...
                        {schedule.options.map((option, index) => (
                          <div key={index} className="p-4 border rounded-lg">
                            <div className="flex justify-between items-center mb-2">
                              ...
                              <Badge className="bg-brand-100 text-brand-800">{option.duration}</Badge>
                            </div>
                      ...
                      <div className="mt-8 pt-6 border-t">
                        ...
                        <div className="bg-gradient-to-r from-brand-50 to-accent-50 rounded-lg p-6">
                          {programs.find(p => p.name === schedule.program)?.durationOptions ? (
                            <div className="space-y-3">
                              {programs.find(p => p.name === schedule.program)?.durationOptions?.map((option, index) => (
                            ...
                            <div className="text-center">
                              <span className="text-2xl font-bold text-brand-600">
                                {programs.find(p => p.name === schedule.program)?.price}
                              </span>
                              <p className="text-neutral-600 mt-2">
                                {programs.find(p => p.name === schedule.program)?.duration}
                              </p>
                            </div>
                          )}
                        </div>
        ...
        <section className="py-16 bg-neutral-50">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-2xl mx-auto mb-16">
              <h2 className="text-display-sm md:text-display-md font-bold mb-4">Requirements & Target Outcomes</h2>
              <p className="text-lg text-neutral-600">
                Know what to expect and what you'll achieve with our programs.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>What you need to enroll in our programs</CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>What you'll achieve by completing our programs</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-6">
                    {outcomes.map((outcome) => (
                      <div key={outcome.program}>
                        <h4 className="font-semibold mb-2">{outcome.program}</h4>
                        <ul className="space-y-2">
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-2xl mx-auto mb-16">
              <h2 className="text-display-sm md:text-display-md font-bold mb-4">Placement Test</h2>
              <p className="text-lg text-neutral-600">
                Take our short placement test to determine your current English level and get a program recommendation.
              </p>
            </div>
            ...
            <div className="max-w-2xl mx-auto">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Fill out the form below and we'll recommend the right program for you
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  {formSubmitted ? (
                    <Alert className="border-green-200 bg-green-50">
                      ...
                      <AlertDescription className="text-green-700">
                        Thank you for taking our placement test! Our team will review your information and send a program recommendation to your email shortly.
                      </AlertDescription>
                    </Alert>
                  ) : (
                    <form onSubmit={handleSubmit} className="space-y-4">
                      ...
                      <div>
                        <label htmlFor="programInterest" className="block text-sm font-medium mb-1">
                          Program of Interest *
                        </label>
                        <select
                          id="programInterest"
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="text-center max-w-4xl mx-auto text-white">
              ...
              <p className="text-xl text-white/90 mb-10 leading-relaxed max-w-3xl mx-auto">
                Join thousands of students who have improved their English skills with our specialized programs. 
                Contact us today to discuss your learning goals and find the perfect program for you.
              </p>
              ...
              <div className="pt-8 border-t border-white/20">
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 max-w-2xl mx-auto">
                  ...
                  <p className="text-white/90 font-medium">
                    <strong className="text-white">Pro tip:</strong> Mention "website inquiry" when you contact us for special rates and bundling options with our accommodation packages
                  </p>
                </div>
              </div>
            </div>
