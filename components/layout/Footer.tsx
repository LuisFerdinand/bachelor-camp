      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-neutral-400 mb-4">
              Premium English learning experience with professional facilities
          ...
          <div>
            ...
            <div className="overflow-hidden h-48 border-2 border-neutral-700 shadow-lg">
              <Map
                coordinates={coordinates}
                title="BachelorCamp Kediri"
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            <Link
              href="#"
              className="text-neutral-500 hover:text-brand-400 text-sm"
            >
              Privacy Policy
            </Link>
            <Link
