...
export const CAMP_DESKTOP_FALLBACK = "/Camp/CampBgDesktop.png";
export const CAMP_MOBILE_FALLBACK = "/Camp/CampBgMobile.png";
export const CONTACT_BANNER_FALLBACK = "/Contact/ContactBanner.png";
export const PROGRAM_BANNER_FALLBACK = "/Program/ProgBanner.png";
...
export const ACTIVITY_FALLBACKS = {
  activity1: "/activity/Activity1.png",
  activity2: "/activity/Activity2.png",
  activity3: "/activity/Activity3.png",
  activity4: "/activity/Activity4.png",
  activity5: "/activity/Activity5.png",
  activity6: "/activity/Activity6.png",
} as const;

// Facilities fallbacks
export const FACILITIES_FALLBACKS = {
  culinaryCenter: "/home/facilities/culCen.png",
  internetFood: "/home/facilities/intFood.png",
...
export const STUDENT_LIFE_FALLBACKS = {
  mobile: "/student-life/student-life-mobile.png",
  desktop: "/student-life/student-life.png",
} as const;

// Test fallbacks
export const TEST_IMAGE_FALLBACK = "/testi/testi.png";

// Icon fallback (keeping your existing one)
