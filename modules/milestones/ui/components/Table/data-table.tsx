...
import { Milestone } from "@/db/schema"; // adjust import if needed
import { useMilestoneFilters } from "@/modules/milestones/hooks/use-milestone-filters"; // <-- create similar to usePillarFilters
...
export function MilestoneDataTable<TData, TValue>({
  columns,
  data,
  isLoading,
  ...
  const [{ searchQuery }, setFilters] = useMilestoneFilters();
