...
import { useTestimonialFilters } from "@/modules/testimonials/hooks/use-testimonial-filters";
...
export function DataTable<TData, TValue>({
  ...
  // custom hook (same style as useBannerFilters)
  const [{ searchQuery }, setFilters] = useTestimonialFilters();
            ...
            <TableBody>
              {table.getRowModel().rows.length ? (
                table.getRowModel().rows.map((row) => {
                  const testimonial = row.original as TestimonialWithCategories;
                  return (
                    <TableRow
