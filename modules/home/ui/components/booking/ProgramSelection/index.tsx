...
import { Users, Clock, Star, CheckCircle, Home } from "lucide-react";
import { Course, Building } from "@/app/util/bookingData";
        ...
        {!selectedBuilding ? (
          <div className="text-center py-8">
            ...
            <p className="text-neutral-500">
              Please select a building first to view available programs
            </p>
          </div>
        ) : (
          <>
