...
export function ContactHeroSection({ scrollToForm }: ContactHeroSectionProps) {
  const { data: banner, isLoading: isLoadingBanner } =
    trpc.banners.getOne.useQuery({ type: "Contact" });
    ...
    <section className="relative py-20 md:py-32 overflow-hidden">
      <div className="absolute inset-0">
        <div className="block absolute inset-0">
          <Image
            src={banner?.mediaUrl || CONTACT_BANNER_FALLBACK}
            alt={banner?.headline || "Contact Banner"}
            fill
