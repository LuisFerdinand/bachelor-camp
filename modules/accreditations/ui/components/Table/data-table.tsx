...
import { useAccreditationFilters } from "@/modules/accreditations/hooks/use-accreditation-filters";
...
export function DataTable<TData, TValue>({
  ...
  const [{ searchQuery }, setFilters] = useAccreditationFilters();
            ...
            <TableBody>
              {table.getRowModel().rows.length ? (
                table.getRowModel().rows.map((row) => {
                  const accreditation = row.original as Accreditation;
                  return (
                    <TableRow
