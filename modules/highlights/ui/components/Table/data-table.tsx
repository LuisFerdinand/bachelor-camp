...
import { useHighlightFilters } from "@/modules/highlights/hooks/use-highlight-filters";
...
export function HighlightsDataTable<TData, TValue>({
  columns,
  data,
  isLoading,
  ...
  const [{ searchQuery }, setFilters] = useHighlightFilters();
            ...
            <TableBody>
              {table.getRowModel().rows.length ? (
                table.getRowModel().rows.map((row) => {
                  const highlight = row.original as Highlight;
                  return (
                    <TableRow
