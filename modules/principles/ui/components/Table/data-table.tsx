...
import { usePrincipleFilters } from "@/modules/principles/hooks/use-principle-filters";
...
export function PrinciplesDataTable<TData, TValue>({
  columns,
  data,
  isLoading,
  ...
  const [{ searchQuery }, setFilters] = usePrincipleFilters();
            ...
            <TableBody>
              {table.getRowModel().rows.length ? (
                table.getRowModel().rows.map((row) => {
                  const principle = row.original as Principle;
                  return (
                    <TableRow
